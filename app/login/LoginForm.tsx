...
export default function LoginForm() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    // Cria o cliente dentro do handler — só roda no browser
  ...
  return (
    <div className="app-shell">
      <div className="flex-1 flex flex-col items-center justify-center px-6 py-7">
        {/* Logo */}
        <div className="w-13 h-13 bg-[#1D9E75] rounded-2xl flex items-center justify-center mb-5">
        ...
        <form onSubmit={handleSubmit} className="w-full flex flex-col gap-3">
          {error && (
            <div className="text-xs text-[#A32D2D] bg-[#FCEBEB] rounded-lg px-3 py-2 text-center font-medium">
              {error}
            </div>
          )}
          ...
          <p className="text-xs text-gray-400 text-center mt-2">
            ...
            <button
              ...
              className="text-[#1D9E75] underline font-semibold"
            >
